...
const MainCard = ({card}) => {
    ...
    const {author,title,image_url,rating,total_view,details,_id} = card;

    return (
        <div className="mb-16 border">
           <div className="flex justify-between items-center bg-[#F3F3F3] border px-4 py-3">
                <div className="flex items-center gap-4">
                    <img src={author.img} className="w-10 h-10 rounded-lg" />
                    <div>
                        <h1>{author.name}</h1>
           ...
           <div className="flex flex-col justify-center px-5"> 
                ...
                {
                    details.length > 200 ? 
                    <p className="mt-4 mx-4 text-xl font-regular text-[#706F6F] rounded-sm">{details.slice(0,200)} 
                    <br />
